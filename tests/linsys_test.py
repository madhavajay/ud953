...
def test_linsys_multiply_row():
    ...
    new_plane_3 = Plane(normal_vector=Vector([-1, -1, 1]), constant_term=-3)
    ...
    new_plane_1 = Plane(normal_vector=Vector([10, 10, 10]), constant_term=10)
...
def test_linsys_multiply_row_add():
    ...
    plane_2 = Plane(Vector([0, 1, 0]), constant_term=2)
    new_plane_1 = Plane(Vector([10, 10, 10]), constant_term=10)
    new_plane_3 = Plane(Vector([-1, -1, 1]), constant_term=-3)
    plane_4 = Plane(Vector([1, 0, -2]), constant_term=2)
    ...
    plane_1_added = Plane(Vector([10, 11, 10]), constant_term=12)
    ...
    plane_2_subtracted = Plane(Vector([-10, -10, -10]), constant_term=-10)
